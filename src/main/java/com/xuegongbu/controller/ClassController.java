...
public class ClassController {
    ...
    public Result<Class> getClassById(@PathVariable String id) {
    ...
    public Result<String> updateClassById(@PathVariable String id, @RequestBody Class classEntity) {
    ...
    public Result<String> deleteClassById(@PathVariable String id) {
